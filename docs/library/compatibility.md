...
- Runtime session-result fixtures for approval rejection, approval hook error, approval timeout
  ...
  envelope sanitization, server-origin unsupported method denial, and invalid server-origin ping
  response denial, upstream error data redaction, and upstream error message redaction.
