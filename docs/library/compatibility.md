...
- Runtime session-result fixtures for approval rejection, approval hook error, approval timeout
  ...
  envelope sanitization, server-origin unsupported method denial, server-origin ping params denial,
  invalid server-origin ping response denial, upstream error data redaction, upstream error message
