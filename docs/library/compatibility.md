...
- Runtime session-result fixtures for approval rejection, approval hook error, approval timeout
  fail-closed behavior, duplicate discovery sanitization, malformed discovery sanitization,
  client unsupported method denial, server-origin unsupported method denial, and invalid
  server-origin ping response denial.
