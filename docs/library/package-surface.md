...
- Package artifact and export surface: the approved `0.2.0-alpha.2` candidate record names five
  public npm packages.
...
public `0.2.0-alpha.2` candidate posture while preserving workspace ownership and internal imports.
