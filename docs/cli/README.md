...
Host-specific descriptors target the official Codex and Gemini `mcp add` commands. They generate
registration argv only and never edit host configuration directly.
