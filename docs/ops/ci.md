...
- package surface, tracked-file secret scans, compatibility evidence checks, and dependency license
  report checks
...
- Required validation names: typecheck, test, contract, docs, package-surface, secret-scan,
  compatibility, license-report, check.
