...
- Required validation names: test, docs, migration-check, package-surface, artifact-safety,
  repository-hygiene, validation-registry, ci-contract, release-readiness, check
